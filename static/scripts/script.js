...
open_modal(modal_id);
fill_in_info_reoccur_modal(task_id);
}
...
function fill_in_info_reoccur_modal(task_id)
{
var task = document.getElementsByName(task_id);
// pass input from task value to modal
document.getElementById('task_modal_head_description').innerHTML = task[1].value;
...
document.getElementById('task_duration').innerHTML = task[8].value + ' minutes';
document.getElementById('task_responsible').innerHTML = task[2].value;
document.getElementById('task_instruction').innerHTML = task[9].value;
document.getElementById('task_LastCreation').innerHTML = task[13].value;
document.getElementById('task_Department').innerHTML = task[3].value;
